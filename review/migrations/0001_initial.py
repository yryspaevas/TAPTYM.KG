...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('likes', models.ManyToManyField(blank=True, related_name='like_place', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(related_name='like_hotel', to=settings.AUTH_USER_MODEL)),
                ('user_comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotel_likes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FunRating',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(related_name='like_fun', to=settings.AUTH_USER_MODEL)),
