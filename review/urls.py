...
urlpatterns = [
    ...
    path('add_favorite_place/<int:place_id>/', add_favorite_place),
    path('add_favorite_fun/<int:fun_id>/', add_favorite_fun),
    path('add_favorite_hotel/<int:hotel_id>/', add_favorite_hotel),
]